...
5. [Expiration and Eviction](#5-expiration-and-eviction)
6. [Invalidation Strategies](#6-invalidation-strategies)
7. [Failure and Scale Problems](#7-failure-and-scale-problems)
8. [How to Choose a Pattern](#8-how-to-choose-a-pattern)
...
9. How will you measure hit rate, latency, and backend load?
...
9. Define TTL and explain the freshness tradeoff.
10. Compare LRU and LFU eviction.
11. Explain cache invalidation for entity data vs aggregate views.
12. Explain cache stampede and how to prevent it.
13. Explain hot keys and cache avalanche.
14. Explain why personalized responses need careful cache keys.
15. Say when you should not cache authoritative data.
