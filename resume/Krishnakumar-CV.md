...
- **Owned** a fault-tolerant fulfillment subsystem syncing across **4 sales channels** (hundreds of thousands of events per day), designed for idempotent consumers, ordered delivery, and safe recovery under partial failures. Scaled it to sustain **75 TPS** through database partitioning, sharding, and load-based autoscaling, verifying the throughput with custom load-generation scripts.
